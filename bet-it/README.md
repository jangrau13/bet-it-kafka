...
You can run the main java file [SpringBootKafkaApplication.java](/bet-it/base-application/src/main/java/ch/unisg/kafka/spring/SpringBootKafkaApplication.java) of the Spring Boot project directly via your IDE
